...
This basically calculating the conditional effects for the existing groups in the dataset. This tutorial (https://www.andrewheiss.com/blog/2021/11/10/ame-bayes-re-guide/#conditional-effects-for-existing-groups) produces the same values - I just use parameters straight from the model to calculate the individual effects. Using that tutorial also provides 95% HDIs for each individual. 
