...
This dataframe contains an example fixation pattern for plotting Figure 4.

```{r}
# Setting digits to 15 mins that fixation duration s are not rounded to annoying precise. 
options(digits = 15)
example.fixation <- fread(file = here::here("gaze_entropy_heterogenous/data/example.fixation.csv"))
```
