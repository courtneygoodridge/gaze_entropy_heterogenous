...
# plot saving
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig5.tiff"), plot = n_back_age_performance , width = 12, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
# saving final plot
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig6.tiff"), plot = sge.plot, width = 12, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
# saving plots
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig7.tiff"), plot = sge.plot.sigma, width = 12, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
# plot saving
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig8.tiff"), plot = posterior.mean.intervals.sge, width = 16, height = 10, units = 'cm', dpi = 300, type = 'cairo')
```
...
# data saving
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig9.tiff"), plot = population.plot, width = 16, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig10.tiff"), plot = gte.plot, width = 12, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig11.tiff"), plot = sge.plot.sigma, width = 12, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig12.tiff"), plot = posterior.mean.intervals.gte, width = 16, height = 10, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig13.tiff"), plot = population.plot.gte, width = 16, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig14.tiff"), plot = population.plot.sigma.gte, width = 16, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig15.tiff"), plot = age.nback.effect.sge , width = 12, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
ggsave(here::here("gaze_entropy_heterogenous/plots/Fig16.tiff"), plot = age.nback.effect.gte, width = 12, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
